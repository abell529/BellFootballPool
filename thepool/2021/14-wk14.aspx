<%@ Page Language="C#" AutoEventWireup="true" CodeFile="14-wk14.aspx.cs" Inherits="_2021_14_wk14" %>
...
<head runat="server">
    <title>
		Week 14 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 14: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65091", "65092", "65093", "65094", "65095", "65096", "65097", "65098", "65099", "65100", "65101", "65102" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "65091", "65092", "65093", "65094", "65095", "65096", "65097", "65098", "65099", "65100", "65101", "65102" };
