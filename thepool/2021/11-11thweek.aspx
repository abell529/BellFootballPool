<%@ Page Language="C#" AutoEventWireup="true" CodeFile="11-11thweek.aspx.cs" Inherits="_2021_11_11thweek" %>
...
<head runat="server">
    <title>
		Week 11 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 11: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65047", "65048", "65049", "65050", "65051", "65052", "65053", "65054", "65055", "65056", "65057", "65058", "65059" };
                for (int i = 0; i < 15; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "65047", "65048", "65049", "65050", "65051", "65052", "65053", "65054", "65055", "65056", "65057", "65058", "65059" };
