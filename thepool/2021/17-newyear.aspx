<%@ Page Language="C#" AutoEventWireup="true" CodeFile="17-newyear.aspx.cs" Debug="true" Inherits="_2021_17_newyear" %>
...
<head runat="server">
    <title>
		Week 17 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 17: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
    <div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65136", "65137", "65139", "65140", "65141", "65142", "65143", "65144", "65145", "65146", "65147", "65148", "65149", "65150", "65151" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] gamePicksList = { game0List[i], game1List[i], game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i], game14List[i]  };
                    string[] sundayPickGameIDs = {  "65136", "65137", "65139", "65140", "65141", "65142", "65143", "65144", "65145", "65146", "65147", "65148", "65149", "65150", "65151" };
