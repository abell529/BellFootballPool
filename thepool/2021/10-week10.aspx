<%@ Page Language="C#" AutoEventWireup="true" CodeFile="10-week10.aspx.cs" Inherits="_2021_10_week10" %>
...
<head runat="server">
    <title>
		Week 10 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 10: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65033", "65034", "65035", "65036", "65037", "65038", "65039", "65040", "65041", "65042", "65043", "65044" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "65033", "65034", "65035", "65036", "65037", "65038", "65039", "65040", "65041", "65042", "65043", "65044" };
