<%@ Page Language="C#" AutoEventWireup="true" CodeFile="13-13thweek.aspx.cs" Inherits="_2021_13_13thweek" %>
...
<head runat="server">
    <title>
		Week 13 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 13: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65077", "65078", "65079", "65080", "65081", "65082", "65083", "65084", "65085", "65086", "65087", "65088" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "65077", "65078", "65079", "65080", "65081", "65082", "65083", "65084", "65085", "65086", "65087", "65088" };
