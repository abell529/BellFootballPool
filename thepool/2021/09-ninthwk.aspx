<%@ Page Language="C#" AutoEventWireup="true" CodeFile="09-ninthwk.aspx.cs" Inherits="_2021_09_ninthwk" %>
...
<head runat="server">
    <title>
		Week 9 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 9: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65018", "65019", "65021", "65022", "65023", "65024", "65025", "65026", "65027", "65028", "65029", "65030" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "65018", "65019", "65021", "65022", "65023", "65024", "65025", "65026", "65027", "65028", "65029", "65030" };
