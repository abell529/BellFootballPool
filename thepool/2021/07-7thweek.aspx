<%@ Page Language="C#" AutoEventWireup="true" CodeFile="07-7thweek.aspx.cs" Inherits="_2021_07_7thweek" %>
...
<head runat="server">
    <title>
		Week 7 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 7: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "64990", "64991", "64992", "64993", "64994", "64995", "64996", "64997", "64998", "64999", "65000" };
                for (int i = 0; i < 13; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "64990", "64991", "64992", "64993", "64994", "64995", "64996", "64997", "64998", "64999", "65000" };
