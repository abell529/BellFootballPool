<%@ Page Language="C#" AutoEventWireup="true" CodeFile="18-18thwk2021.aspx.cs" Debug="true" Inherits="_2021_18_18thwk2021" %>
...
<head runat="server">
    <title>
		Week 18 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 18: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
    <div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65153", "65154", "65155", "65156", "65157", "65158", "65159", "65160", "65161", "65162", "65163", "65164", "65165", "65166" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                    ...
                    else
                    {
                        ...
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores2.scoreboard.gameScore[13].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores2.scoreboard.gameScore[13].homeScore + "</span></div>");
                        Response.Write("</div>");
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "65153", "65154", "65155", "65156", "65157", "65158", "65159", "65160", "65161", "65162", "65163", "65164", "65165", "65166" };
