<%@ Page Language="C#" AutoEventWireup="true" CodeFile="12-thxgiv.aspx.cs" Inherits="_2021_12_thxgiv" %>
...
<head runat="server">
    <title>
		Week 12 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 12: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65346", "65064", "65065", "65066", "65067", "65068", "65069", "65070", "65072", "65073", "65074" };
                for (int i = 0; i < 15; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    if (game1List[i] == (livescores.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        ...
                        {
                            Response.Write("<span class='away'>" + livescores.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        {
                            Response.Write("<span class='home'>" + livescores.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                    }
                    ...
                    if (game2List[i] == (livescores.scoreboard.gameScore[2].game.awayTeam.City + " " + livescores.scoreboard.gameScore[2].game.awayTeam.Name))
                    {
                        ...
                        {
                            Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='away'>" + livescores.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y)
                        {
                            Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        }
                        else if (y > x)
                        {
                        ...
                        {
                            Response.Write("<span class='home'>" + livescores.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        }
                    }

                    

                    string[] gamePicksList = { game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i]  };
                    string[] sundayPickGameIDs = {  "65346", "65064", "65065", "65066", "65067", "65068", "65069", "65070", "65072", "65073", "65074" };
