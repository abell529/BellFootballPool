<%@ Page Language="C#" AutoEventWireup="true" CodeFile="06-weeksix.aspx.cs" Inherits="_2021_06_weeksix" %>
...
<head runat="server">
    <title>
		Week 6 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 6: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "64976", "64977", "64978", "64979", "64980", "64981", "64982", "64983", "64984", "64985", "64986", "64987" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    string[] sundayPickGameIDs = {  "64976", "64977", "64978", "64979", "64980", "64981", "64982", "64983", "64984", "64985", "64986", "64987" };
