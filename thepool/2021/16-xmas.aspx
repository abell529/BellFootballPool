<%@ Page Language="C#" AutoEventWireup="true" CodeFile="16-xmas.aspx.cs" Debug="true" Inherits="_2021_16_xmas" %>
...
<head runat="server">
    <title>
		Week 16 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 16: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65121", "65122", "65123", "65124", "65125", "65126", "65127", "65128", "65129", "65130", "65131", "65132" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    if (game2List[i] == (livescoressat.scoreboard.gameScore[1].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        ...
                        {
                            Response.Write("<span class='loss'>" + livescoressat.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='away'>" + livescoressat.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y)
                        {
                            Response.Write("<span class='loss'>" + livescoressat.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                        else if (y > x)
                        {
                        ...
                        {
                            Response.Write("<span class='home'>" + livescoressat.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                    }
                    ...
                    string[] sundayPickGameIDs = {  "65121", "65122", "65123", "65124", "65125", "65126", "65127", "65128", "65129", "65130", "65131", "65132" };
