<%@ Page Language="C#" AutoEventWireup="true" CodeFile="15-weekbeforexmas.aspx.cs" Debug="true" Inherits="_2021_15_weekbeforexmas" %>
...
<head runat="server">
    <title>
		Week 15 2021 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2021 Week 15: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "65105", "65106", "65107", "65108", "65109", "65110", "65111", "65112", "65115", "65118" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                    ...
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescoressat.scoreboard.gameScore[0].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                    ...
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores3.scoreboard.gameScore[1].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores3.scoreboard.gameScore[1].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i == 14)
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescorestue.scoreboard.gameScore[0].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescorestue.scoreboard.gameScore[0].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else
                    {

                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescorestue.scoreboard.gameScore[1].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescorestue.scoreboard.gameScore[1].homeScore + "</span></div>");
                        Response.Write("</div>");
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    if (game1List[i] == (livescoressat.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        ...
                        if (x > y)
                        {
                            Response.Write("<span class='win'>" + livescoressat.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        }
                        else if (y > x)
                        {
                            Response.Write("<span class='loss'>" + livescoressat.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='away'>" + livescoressat.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y)
                        {
                            Response.Write("<span class='loss'>" + livescoressat.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        }
                        else if (y > x)
                        {
                            Response.Write("<span class='win'>" + livescoressat.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='home'>" + livescoressat.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        }
                    }
                    ...
                    string[] gamePicksList = { game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i]  };
                    string[] sundayPickGameIDs = {  "65105", "65106", "65107", "65108", "65109", "65110", "65111", "65112", "65115", "65118" };
                    ...
                    if (game12List[i]  == (livescores3.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    if (game13List[i]  == (livescores3.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    if (game14List[i]  == (livescorestue.scoreboard.gameScore[0].game.awayTeam.City + " " + livescorestue.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescorestue.scoreboard.gameScore[0].awayScore, out x);
                        Int32.TryParse(livescorestue.scoreboard.gameScore[0].homeScore, out y);
                        if (x > y && (livescorestue.scoreboard.gameScore[0].isCompleted == "true"))
                        {
                            Response.Write("<span class='win'>" + livescorestue.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        }
                        else if (x < y && (livescorestue.scoreboard.gameScore[0].isCompleted == "true"))
                        {
                            Response.Write("<span class='loss'>" + livescorestue.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='away'>" + livescorestue.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y && (livescorestue.scoreboard.gameScore[0].isCompleted == "true"))
                        {
                            Response.Write("<span class='loss'>" + livescorestue.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        }
                        else if  (x < y && (livescorestue.scoreboard.gameScore[0].isCompleted == "true"))
                        {
                            Response.Write("<span class='win'>" + livescorestue.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='home'>" + livescorestue.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        }
                    }

                    Response.Write("</div><div class='divTableCell' style = 'background:#ffffff;'>");

                    if (game15List[i]  == (livescorestue.scoreboard.gameScore[1].game.awayTeam.City + " " + livescorestue.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescorestue.scoreboard.gameScore[1].awayScore, out x);
                        Int32.TryParse(livescorestue.scoreboard.gameScore[1].homeScore, out y);
                        if (x > y && (livescorestue.scoreboard.gameScore[1].isCompleted == "true"))
                        {
                            Response.Write("<span class='win'>" + livescorestue.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                        else if (x < y && (livescorestue.scoreboard.gameScore[1].isCompleted == "true"))
                        {
                            Response.Write("<span class='loss'>" + livescorestue.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='away'>" + livescorestue.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y && (livescorestue.scoreboard.gameScore[1].isCompleted == "true"))
                        {
                            Response.Write("<span class='loss'>" + livescorestue.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                        else if  (x < y && (livescorestue.scoreboard.gameScore[1].isCompleted == "true"))
                        {
                            Response.Write("<span class='win'>" + livescorestue.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='home'>" + livescorestue.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                    }
