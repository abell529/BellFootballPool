<%@ Page Language="C#" AutoEventWireup="true" CodeFile="06-6thweek.aspx.cs" Inherits="_2020_06_6thweek"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 6 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 6: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "56829", "56839", "56840", "56842", "56843", "56844", "56845", "56846", "56847", "56894", "56837", "56836" };
               for (int i = 0; i < 14; i++)
               {
                   if (i % 2 == 0)
                   {
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   {
                       if (theFirstNamePicks[s] == theFirstNamePicks[i] && theLastNamePicks[s] == theLastNamePicks[i])
                       {
                           for (int n = 0; n <= (theFirstNameScore.Length-1); n++)
                           {
                               if (theFirstNamePicks[s] == theFirstNameScore[n] && theLastNamePicks[s] == theLastNameScore[n])
                               {
                   ...
                   string[] gamePicksList = { game0List[i], game1List[i], game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i]  };
                   string[] sundayPickGameIDs = {  "56829", "56839", "56840", "56842", "56843", "56844", "56845", "56846", "56847", "56894", "56837", "56836" };
