...
public partial class _2020_17_2020wk17 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM seventeen2020 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15, string game16)
    {
        ...
        if (game2 == (livescores4.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[0].game.awayTeam.Name))
        {
            int x;
            int y;
        ...
        if (game3 == (livescores4.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[1].game.awayTeam.Name))
        {
            int x;
            int y;
        ...
        if (game4 == (livescores4.scoreboard.gameScore[2].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[2].game.awayTeam.Name))
        {
            int x;
            int y;
        ...
        */
        ...
        string[] gamePicks = { game1, game2, game3, game4, game5, game6, game7, game8, game9, game10, game11, game12, game13, game14, game15, game16 };
