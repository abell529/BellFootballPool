<%@ Page Language="C#" AutoEventWireup="true" CodeFile="08-8thwk.aspx.cs" Inherits="_2020_08_8thwk"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 8 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 8: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "56860", "56868", "56869", "56870", "56871", "56872", "56873", "56874", "56907", "56865", "56866", "56864" };
               for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                    ...
                    else if (i > 0 && i < 13 )
                    {
                        ...
                        while (b < sundayPickGameIDsA.Length)
                        {
                            ...
                            {
                                for (int c = 1; c <= livescores2.scoreboard.gameScore.Length; c++)
                                {
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   string[] sundayPickGameIDs = {  "56860", "56868", "56869", "56870", "56871", "56872", "56873", "56874", "56907", "56865", "56866", "56864" };
