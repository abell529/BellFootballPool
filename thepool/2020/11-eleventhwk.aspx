<%@ Page Language="C#" AutoEventWireup="true" CodeFile="11-eleventhwk.aspx.cs" Inherits="_2020_11_eleventhwk"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 11 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 11: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "56908", "56909", "56910", "56912", "56913", "56914", "56915", "56838", "56841", "56906", "56911", "56905" };
               for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   string[] sundayPickGameIDs = {  "56908", "56909", "56910", "56912", "56913", "56914", "56915", "56838", "56841", "56906", "56911", "56905" };
