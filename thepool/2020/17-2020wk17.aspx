<%@ Page Language="C#" AutoEventWireup="true" CodeFile="17-2020wk17.aspx.cs" Inherits="_2020_17_2020wk17"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 17 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 17: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "57006", "57008", "57009", "57011", "57012", "57013", "57015", "56753", "57002", "57003", "57004", "57005", "57010", "57014", "57016", "57007" };
               for (int i = 0; i < 16; i++)
               {
                   if (i % 2 == 0)
                   {
                   ...
                   {
                       Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores4.scoreboard.gameScore[0].awayScore + "</span></div>");
                       Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                       Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores4.scoreboard.gameScore[0].homeScore + "</span></div>");
                       Response.Write("</div>");
                   }
                   else if (i == 2)
                   {

                       Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores4.scoreboard.gameScore[1].awayScore + "</span></div>");
                       Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                       Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores4.scoreboard.gameScore[1].homeScore + "</span></div>");
                       Response.Write("</div>");
               ...
               Response.Write("<div class='divTableCell tk-ardoise-compact-std heavy-font' style = 'background:#ffffff;'></div>");
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   Response.Write("</div><div class='divTableCell' style = 'background:#eae9e5; text-align:center;'>" );

                   if (game1List[i] == (livescores4.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[0].game.awayTeam.Name))
                   {
                       int x;
                       int y;
                       Int32.TryParse(livescores4.scoreboard.gameScore[0].awayScore, out x);
                       Int32.TryParse(livescores4.scoreboard.gameScore[0].homeScore, out y);
                       if  (x > y && (livescores4.scoreboard.gameScore[0].isCompleted == "true"))
                       {
                           Response.Write("<span class='win'>" + livescores4.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                       }
                       else if (x < y && (livescores4.scoreboard.gameScore[0].isCompleted == "true"))
                       {
                           Response.Write("<span class='loss'>" + livescores4.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                       }
                       else
                       {
                           Response.Write("<span class='away'>" + livescores4.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                       }
                   }
                   else
                   {
                       ...
                       if  (x > y && (livescores4.scoreboard.gameScore[0].isCompleted == "true"))
                       {
                           Response.Write("<span class='loss'>" + livescores4.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                       }
                       else if (x < y && (livescores4.scoreboard.gameScore[0].isCompleted == "true"))
                       {
                           Response.Write("<span class='win'>" + livescores4.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                       }
                       else
                       {
                           Response.Write("<span class='home'>" + livescores4.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                       }
                   }
                   Response.Write("</div><div class='divTableCell' style = 'background:#ffffff; text-align:center;'>" );

                   if (game2List[i] == (livescores4.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[1].game.awayTeam.Name))
                   {
                       int x;
                       int y;
                       Int32.TryParse(livescores4.scoreboard.gameScore[1].awayScore, out x);
                       Int32.TryParse(livescores4.scoreboard.gameScore[1].homeScore, out y);
                       if  (x > y && (livescores4.scoreboard.gameScore[1].isCompleted == "true"))
                       {
                           Response.Write("<span class='win'>" + livescores4.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                       }
                       else if (x < y && (livescores4.scoreboard.gameScore[1].isCompleted == "true"))
                       {
                           Response.Write("<span class='loss'>" + livescores4.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                       }
                       else
                       {
                           Response.Write("<span class='away'>" + livescores4.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                       }
                   }
                   else
                   {
                       ...
                       if  (x > y && (livescores4.scoreboard.gameScore[1].isCompleted == "true"))
                       {
                           Response.Write("<span class='loss'>" + livescores4.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                       }
                       else if (x < y && (livescores4.scoreboard.gameScore[1].isCompleted == "true"))
                       {
                           Response.Write("<span class='win'>" + livescores4.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                       }
                       else
                       {
                           Response.Write("<span class='home'>" + livescores4.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                       }
                   }

                   Response.Write("</div><div class='divTableCell' style = 'background:#eae9e5; text-align:center;'>" );

                   if (game3List[i] == (livescores4.scoreboard.gameScore[2].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[2].game.awayTeam.Name))
                   {
                       int x;
                       int y;
                       Int32.TryParse(livescores4.scoreboard.gameScore[2].awayScore, out x);
                       Int32.TryParse(livescores4.scoreboard.gameScore[2].homeScore, out y);
                       if  (x > y && (livescores4.scoreboard.gameScore[2].isCompleted == "true"))
                       {
                           Response.Write("<span class='win'>" + livescores4.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                       }
                       else if (x < y && (livescores4.scoreboard.gameScore[2].isCompleted == "true"))
                       {
                           Response.Write("<span class='loss'>" + livescores4.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                       }
                       else
                       {
                           Response.Write("<span class='away'>" + livescores4.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                       }
                   }
                   else
                   {
                       ...
                       if  (x > y && (livescores4.scoreboard.gameScore[2].isCompleted == "true"))
                       {
                           Response.Write("<span class='loss'>" + livescores4.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                       }
                       else if (x < y && (livescores4.scoreboard.gameScore[2].isCompleted == "true"))
                       {
                           Response.Write("<span class='win'>" + livescores4.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                       }
                       else
                       {
                           Response.Write("<span class='home'>" + livescores4.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                       }
                   }
                   */
                   ...
                   string[] gamePicksList = { game0List[i], game1List[i], game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i], game14List[i], game15List[i]  };
                   string[] sundayPickGameIDs = {  "57006", "57008", "57009", "57011", "57012", "57013", "57015", "56753", "57002", "57003", "57004", "57005", "57010", "57014", "57016", "57007" };
