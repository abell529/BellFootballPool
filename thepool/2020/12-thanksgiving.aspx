<%@ Page Language="C#" AutoEventWireup="true" CodeFile="12-thanksgiving.aspx.cs" Inherits="_2020_12_thanksgiving"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 12 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 12: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "56924", "56925", "56926", "56927", "56928", "56929", "56930", "56931", "56922", "56923", "56921", "56920" };
               for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   string[] sundayPickGameIDs = {  "56924", "56925", "56926", "56927", "56928", "56929", "56930", "56931", "56922", "56923", "56921", "56920" };
                   ...
                   if (game15List[i]  == (livescores4.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[0].game.awayTeam.Name))
                   {
                       int x;
                       int y;
