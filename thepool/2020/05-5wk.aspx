<%@ Page Language="C#" AutoEventWireup="true" CodeFile="05-5wk.aspx.cs" Inherits="_2020_05_5wk"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 5 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 5: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "56821", "56822", "56823", "56824", "56825", "56827", "56828", "56829", "56830", "56831", "56832", "56833" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
               ...
               // string[] game15List = game15Pick.ToArray();
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "56821", "56822", "56823", "56824", "56825", "56826", "56827", "56828", "56830", "56831", "56832", "56833" };
                    ...
                    else if (game13List[i]  == (livescores3.scoreboard.gameScore[0].game.homeTeam.City + " " + livescores3.scoreboard.gameScore[0].game.homeTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescores3.scoreboard.gameScore[0].awayScore, out x);
                    ...
                    else if  (game14List[i]  == (livescores4.scoreboard.gameScore[0].game.homeTeam.City + " " + livescores4.scoreboard.gameScore[0].game.homeTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescores4.scoreboard.gameScore[0].awayScore, out x);
