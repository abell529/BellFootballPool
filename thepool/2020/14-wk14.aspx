<%@ Page Language="C#" AutoEventWireup="true" CodeFile="14-wk14.aspx.cs" Inherits="_2020_14_wk14"  Debug="true"  %>
...
<head runat="server">
    <title>
		Week 3 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 3: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
                string[] sundayPickGameIDsA = { "56955", "56956", "56957", "56958", "56960", "56961", "56962", "56953", "56954", "56950", "56951", "56952", "56959", "56949" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "56955", "56956", "56957", "56958", "56960", "56961", "56962", "56953", "56954", "56950", "56951", "56952", "56959", "56949" };
