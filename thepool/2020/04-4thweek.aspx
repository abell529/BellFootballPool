<%@ Page Language="C#" AutoEventWireup="true" CodeFile="04-4thweek.aspx.cs" Inherits="_2020_04_4thweek" Debug="true" %>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "56805", "56806", "56808", "56809", "56811", "56812", "56813", "56814", "56815", "56816", "56817", "56818" };
                for (int i = 0; i < 15; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "56805", "56806", "56808", "56809", "56811", "56812", "56813", "56814", "56815", "56816", "56817", "56818" };
                    ...
                    else if (game14List[i]  == (livescores3.scoreboard.gameScore[1].game.homeTeam.City + " " + livescores3.scoreboard.gameScore[1].game.homeTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescores3.scoreboard.gameScore[1].awayScore, out x);
