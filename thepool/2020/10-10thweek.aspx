<%@ Page Language="C#" AutoEventWireup="true" CodeFile="10-10thweek.aspx.cs" Inherits="_2020_10_10thweek"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 10 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 10: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "56891", "56892", "56893", "56895", "56896", "56897", "56898", "56899", "56900", "56901", "56902", "56857" };
               for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   string[] sundayPickGameIDs = {  "56891", "56892", "56893", "56895", "56896", "56897", "56898", "56899", "56900", "56901", "56902", "56857" };
