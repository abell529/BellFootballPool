<%@ Page Language="C#" AutoEventWireup="true" CodeFile="13-13thweek.aspx.cs" Inherits="_2020_13_13thweek"  Debug="true" %>
...
<head runat="server">
    <title>
		Week 13 2020 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2020 Week 13: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
           ...
           <% 
               string[] sundayPickGameIDsA = { "56939", "56941", "56942", "56943", "56944", "56945", "56946", "56937", "56938", "56935", "56936", "56934" };
               for (int i = 0; i < 15; i++)
                {
                    if (i % 2 == 0)
                    {
               ...
               for (int i = 0; i < theFirstNamePicks.Length; i++)
               {
                   ...
                   for (int s = 0; s <= (theFirstNamePicks.Length-1); s++)
                   {
                       if (theFirstNamePicks[s].ToLower() == theFirstNamePicks[i].ToLower() && theLastNamePicks[s].ToLower() == theLastNamePicks[i].ToLower())
                       {
                           for (int n = 0; n <= (theFirstNameScore.Length-1); n++)
                           {
                               ...
                               {
                                   Response.Write("<div class='divTableCell' style = 'background:#c1f1f1; text-align:center;'>" + theTotalScore[n] + "</div>" );
                               }
                           }
                       }
                   ...
                   // Response.Write("<div class='divTableCell' style = 'background:#ffffff;'>");
                    ...
                    if (game1List[i] == (livescores.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescores.scoreboard.gameScore[1].awayScore, out x);
                        Int32.TryParse(livescores.scoreboard.gameScore[1].homeScore, out y);
                        if (x > y)
                        {
                            Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[1].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y)
                        {
                            Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        }
                    }

                   */

                   string[] gamePicksList = { game0List[i], game1List[i], game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i]  };
                   string[] sundayPickGameIDs = {  "56939", "56941", "56942", "56943", "56944", "56945", "56946", "56937", "56938", "56935", "56936", "56934" };
                   ...
                   if (game14List[i]  == (livescores4.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[0].game.awayTeam.Name))
                   {
                       int x;
                       int y;
