...
public partial class _2020_13_13thweek : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var responsescores4 = client.DownloadString(urlscoreswk1pt4);
        ...
        OleDbCommand command = new OleDbCommand("SELECT * from 2020", connection);
        ...
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM thirteen2020 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15)
    {
        ...
        if (game2 == (livescores.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores.scoreboard.gameScore[1].game.awayTeam.Name))
        {
            int x;
            int y;
        ...
        */
        ...
        string[] gamePicks = { game1, game2, game3, game4, game5, game6, game7, game8, game9, game10, game11, game12 };
        ...
        string[] mondaypicks = { game13, game14 };
        ...
        if (game15 == (livescores4.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores4.scoreboard.gameScore[0].game.awayTeam.Name))
        {
            int x;
            int y;
