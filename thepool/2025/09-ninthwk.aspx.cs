...
public partial class _2025_09_ninthwk : System.Web.UI.Page
{
    private const string SeasonSegment = "2025-regular";

    public string ScheduleUrl = $"{CredentialStore.ApiBaseUrl}/{SeasonSegment}/full_game_schedule.json?date=from-20251030-to-20251103";
    ...
    private void LoadParticipants()
    {
        ...
        {
            conn.Open();
            var commandText = "SELECT * FROM `nine2025` ORDER BY UPPER(lastname), UPPER(firstname)";
