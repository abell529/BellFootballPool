<%@ Page Language="C#" AutoEventWireup="true" CodeFile="03-week3.aspx.cs" Debug="true" Inherits="_2025_03_week3" %>
...
<head runat="server">
    <title>
		Week 3 2025 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2025 Week 3: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <%
                for (int i = 0; i < 16; i++)
                {
                    ...
                    else if (i > 0 && i < 15 && sundayGameIDs.Contains(showall.fullgameschedule.gameentry[i].id))
                    {
