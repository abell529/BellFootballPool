...
public partial class _2025_02_secondweek25 : System.Web.UI.Page
{
    public string urlwk2 = $"{CredentialStore.ApiBaseUrl}/2025-regular/full_game_schedule.json?date=from-20250911-to-20250915";
    // public string urlts = $"{CredentialStore.ApiBaseUrl}/2016-2017-regular/overall_team_standings.json?teamstats=W,L,T,PF,PA";

    public string urlscoreswk1pt1 = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250911";
    public string urlscoreswk1pt2 = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250914";
    public string urlscoreswk1pt3 = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250915";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        connPicks.Open();
        MySqlCommand comPicks = new MySqlCommand("SELECT * FROM `two2025` ORDER BY UPPER(lastname), UPPER(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15, string game16)
    {
        ...
        // Sunday games
        string[] gamePicks = { game1, game2, game3, game4, game5, game6, game7, game8, game9, game10, game11, game12, game13, game14 };
