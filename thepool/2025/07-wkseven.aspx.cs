...
public partial class _2025_07_wkseven : System.Web.UI.Page
{
    private const string SeasonSegment = "2025-regular";

    public string ScheduleUrl = $"{CredentialStore.ApiBaseUrl}/{SeasonSegment}/full_game_schedule.json?date=from-20251016-to-20251020";
    ...
    private void LoadParticipants()
    {
        ...
        {
            conn.Open();
            var commandText = "SELECT * FROM `seven2025` ORDER BY UPPER(lastname), UPPER(firstname)";
