...
public partial class _2025_17_seventeen25 : System.Web.UI.Page
{
    private const string SeasonSegment = "2025-regular";

    public string ScheduleUrl = $"{CredentialStore.ApiBaseUrl}/{SeasonSegment}/full_game_schedule.json?date=from-20251225-to-20251229";
    ...
    private void LoadParticipants()
    {
        ...
        {
            conn.Open();
            var commandText = "SELECT * FROM `seventeen2025` ORDER BY UPPER(lastname), UPPER(firstname)";
