...
public partial class _2025_16_the16thweek : System.Web.UI.Page
{
    private const string SeasonSegment = "2025-regular";

    public string ScheduleUrl = $"{CredentialStore.ApiBaseUrl}/{SeasonSegment}/full_game_schedule.json?date=from-20251218-to-20251222";
    ...
    private void LoadParticipants()
    {
        ...
        {
            conn.Open();
            var commandText = "SELECT * FROM `sixteen2025` ORDER BY UPPER(lastname), UPPER(firstname)";
