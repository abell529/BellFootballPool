<%@ Page Language="C#" AutoEventWireup="true" CodeFile="02-secondweek25.aspx.cs" Debug="true" Inherits="_2025_02_secondweek25" %>
...
<head runat="server">
    <title>
		Week 2 2025 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2025 Week 2: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <%
                for (int i = 0; i < 16; i++)
                {
                    ...
                    else if (i > 0 && i < 14 && sundayGameIDs.Contains(showall.fullgameschedule.gameentry[i].id))
                    {
