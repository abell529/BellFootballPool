<%@ Page Language="C#" AutoEventWireup="true" CodeFile="05-fifthwk.aspx.cs" Debug="true" Inherits="_2025_05_fifthwk" %>
...
<head runat="server">
    <title>
		Week 5 2025 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2025 Week 5: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <%
                for (int i = 0; i < 14; i++)
                {
                    ...
                    else if (i > 0 && i < 12 && sundayGameIDs.Contains(showall.fullgameschedule.gameentry[i].id))
                    {
