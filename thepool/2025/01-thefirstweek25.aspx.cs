...
public partial class _2025_01_thefirstweek25 : System.Web.UI.Page
{
    public string urlwk2 = $"{CredentialStore.ApiBaseUrl}/2025-regular/full_game_schedule.json?date=from-20250904-to-20250908";
    // public string urlts = $"{CredentialStore.ApiBaseUrl}/2016-2017-regular/overall_team_standings.json?teamstats=W,L,T,PF,PA";

    public string urlscoreswk1pt1 = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250904";
    public string urlscoreswk1ptsat = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250905";
    public string urlscoreswk1pt2 = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250907";
    public string urlscoreswk1pt3 = $"{CredentialStore.ApiBaseUrl}/2025-regular/scoreboard.json?fordate=20250908";
