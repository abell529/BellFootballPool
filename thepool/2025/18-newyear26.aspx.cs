...
public partial class _2025_18_newyear26 : System.Web.UI.Page
{
    private const string SeasonSegment = "2025-regular";

    public string ScheduleUrl = $"{CredentialStore.ApiBaseUrl}/{SeasonSegment}/full_game_schedule.json?date=from-20260103-to-20260104";
    ...
    private void LoadParticipants()
    {
        ...
        {
            conn.Open();
            var commandText = "SELECT * FROM `eighteen2025` ORDER BY UPPER(lastname), UPPER(firstname)";
