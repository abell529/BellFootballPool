<%@ Page Language="C#" AutoEventWireup="true" CodeFile="08-8thweek.aspx.cs" Inherits="_2017_08_8thweek" %>
...
<head runat="server">
    <title>
		Week Eight -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2017 Week 8: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% for (int i = 0; i < numberofgames; i++)
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] gamePicksList = { game1List[i], game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i] };
