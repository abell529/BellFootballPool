<%@ Page Language="C#" AutoEventWireup="true" CodeFile="15-week15.aspx.cs" Inherits="_2017_15_week15" %>
...
<head runat="server">
    <title>
		Week 15 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2017 Week 15: BellFusion Football Pool Picks</h1>
<p>
            ...
            <% for (int i = 0; i < numberofgames; i++)
                {
                    ...
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescoressat.scoreboard.gameScore[i-1].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescoressat.scoreboard.gameScore[i-1].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i > 2 && i < 15)
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores2.scoreboard.gameScore[i-3].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores2.scoreboard.gameScore[i-3].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] gamePicksListSat = { game1List[i], game2List[i] };
