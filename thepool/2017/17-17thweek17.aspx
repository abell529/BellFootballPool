<%@ Page Language="C#" AutoEventWireup="true" CodeFile="17-17thweek17.aspx.cs" Inherits="_2017_17_17thweek17" %>
...
<body>
    ...
    <h1>2017 Week 17: BellFusion Football Pool Picks</h1>
<p>
            ...
            <% for (int i = 0; i < numberofgames; i++)
                {
                    ...
                    if (i > -1 && i < 16)
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores2.scoreboard.gameScore[i].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores2.scoreboard.gameScore[i].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
