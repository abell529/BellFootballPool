...
public partial class scoreboard_2021 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MySqlCommand command = new MySqlCommand("SELECT * FROM `2021` ORDER BY total DESC", connection);
        ...
        while (reader.Read())
        {
            ...
            week18Correct.Add(reader["week18"].ToString());
