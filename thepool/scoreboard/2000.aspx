<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2000.aspx.cs" Debug="true" Inherits="scoreboard_2000" %>
...
<head runat="server">
    <title>
		2000 BellFusion Football Pool Standings
	</title>
...
<body>
    ...
    <h1>2000 BellFusion Football Pool Standings</h1>
    ...
    <div class='divTableCell'  class='tk-ardoise-compact-std light-font smaller-font' style = 'background:#ffffff; text-align:center;'>TOTAL</div>
        ...
        <%
            ...
            for (int i = 0; i < theFirstNameScores.Length; i++ )
            {
                ...
                string[] gamePicksList = { week1List[i], week2List[i], week3List[i], week4List[i], week5List[i], week6List[i], week7List[i], week8List[i], week9List[i], week10List[i], week11List[i], week12List[i], week13List[i], week14List[i], week15List[i], week16List[i], week17List[i] };
