...
public partial class _2023_18_the18thweek : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        connPicks.Open();
        MySqlCommand comPicks = new MySqlCommand("SELECT * FROM `eighteen2023` ORDER BY UPPER(lastname), UPPER(firstname)", connPicks);
        ...
        OleDbConnection connPicks = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\home\bellfootball.com\wwwroot\BFDB\picks.mdb");
        connPicks.Open();
        OleDbDataReader readerPicks = null;
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM eighteen2023 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15, string game16)
    {
        ...
        */
        ...
        /* string[] mondaypicks = { game14, game15, game16 };
