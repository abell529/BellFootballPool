...
public partial class _2023_15_fifteenthwk : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM fifteen2023 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15, string game16)
    {
        ...
        if (game4 == (livescoressat.scoreboard.gameScore[2].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[2].game.awayTeam.Name))
        {
            int x;
            int y;
        ...
        for (int i = 0; i < 1; i++)
        {
            if (mondaypicks[i] == (livescores3.scoreboard.gameScore[1].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[1].game.awayTeam.Name))
            {
                int x;
                int y;
