<%@ Page Language="C#" AutoEventWireup="true" CodeFile="16-the16thweek.aspx.cs" Debug="true" Inherits="_2023_16_the16thweek" %>
...
<head runat="server">
    <title>
		Week 16 2023 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2023 Week 16: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "114088","114089","114090","114091","114092","114093","114094","114095","114096","114097" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("</div>");
                    ...
                    string[] gamePicksList = { game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i]   };
                    string[] sundayPickGameIDs = {  "114088","114089","114090","114091","114092","114093","114094","114095","114096","114097" };
