...
public partial class _2023_12_thanksgiving23 : System.Web.UI.Page
{
    ...
    public int numberofgamescoresfri;
    ...
    public LiveScoring livescoresfri;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var responsescoresfri = client.DownloadString(urlscoreswk1ptfri);
        ...
        livescoresfri = JsonConvert.DeserializeObject<LiveScoring>(responsescoresfri);
        ...
        numberofgamescoresfri = livescoresfri.scoreboard.gameScore.Length;
        ...
        OleDbCommand command = new OleDbCommand("SELECT * from 2023", connection);
        ...
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM twelve2023 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15, string game16)
    {
        ...
        if (game4 == (livescoresfri.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoresfri.scoreboard.gameScore[0].game.awayTeam.Name))
        {
            int x;
            int y;
        ...
        string[] gamePicks = { game5, game6, game7, game8, game9, game10, game11, game12, game13, game14, game15 };
