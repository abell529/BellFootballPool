<%@ Page Language="C#" AutoEventWireup="true" CodeFile="18-the18thweek.aspx.cs" Debug="true" Inherits="_2023_18_the18thweek" %>
...
<head runat="server">
    <title>
		Week 18 2023 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2023 Week 18: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "114127","114128","114129","114135","114136","114139","114123","114124","114130","114132","114133","114137","114138","114134" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                    ...
                    /* else
                    {
                        ...
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores3.scoreboard.gameScore[2].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores3.scoreboard.gameScore[2].homeScore + "</span></div>");
                        Response.Write("</div>");
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("</div>");
                    ...
                    if (game0List[i] == (livescoressat.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    if (game1List[i] == (livescoressat.scoreboard.gameScore[1].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    string[] gamePicksList = { game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i], game14List[i], game15List[i]   };
                    string[] sundayPickGameIDs = {  "114127","114128","114129","114135","114136","114139","114123","114124","114130","114132","114133","114137","114138","114134" };
                    ...
                    if (game15List[i]  == (livescores3.scoreboard.gameScore[2].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[2].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescores3.scoreboard.gameScore[2].awayScore, out x);
                        Int32.TryParse(livescores3.scoreboard.gameScore[2].homeScore, out y);
                        if (x > y && (livescores3.scoreboard.gameScore[2].isCompleted == "true"))
                        {
                            Response.Write("<span class='win'>" + livescores3.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        }
                        else if (x < y && (livescores3.scoreboard.gameScore[2].isCompleted == "true"))
                        {
                            Response.Write("<span class='loss'>" + livescores3.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='away'>" + livescores3.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        }
                    }
                    else
                    {
                        ...
                        if (x > y && (livescores3.scoreboard.gameScore[2].isCompleted == "true"))
                        {
                            Response.Write("<span class='loss'>" + livescores3.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        }
                        else if  (x < y && (livescores3.scoreboard.gameScore[2].isCompleted == "true"))
                        {
                            Response.Write("<span class='win'>" + livescores3.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        }
                        else
                        {
                            Response.Write("<span class='home'>" + livescores3.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        }
                    }
