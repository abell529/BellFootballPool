<%@ Page Language="C#" AutoEventWireup="true" CodeFile="12-thanksgiving23.aspx.cs" Debug="true" Inherits="_2023_12_thanksgiving23" %>
...
<head runat="server">
    <title>
		Week 13 2024 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2024 Week 13: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "114034","114035","114036","114037","114038","114039","114040","114041","114042","114043","114044" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                    ...
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescoresfri.scoreboard.gameScore[0].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescoresfri.scoreboard.gameScore[0].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i > 3 && i < 15 )
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("</div>");
                    ...
                    if (game2List[i] == (livescores.scoreboard.gameScore[2].game.awayTeam.City + " " + livescores.scoreboard.gameScore[2].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescores.scoreboard.gameScore[2].awayScore, out x);
                        Int32.TryParse(livescores.scoreboard.gameScore[2].homeScore, out y);
                        Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        //}
                    ...
                    else
                    {
                        ...
                        Int32.TryParse(livescores.scoreboard.gameScore[2].awayScore, out x);
                        Int32.TryParse(livescores.scoreboard.gameScore[2].homeScore, out y);
                        Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        //}
                    ...
                    if (game3List[i] == (livescoresfri.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoresfri.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        Int32.TryParse(livescoresfri.scoreboard.gameScore[0].awayScore, out x);
                        Int32.TryParse(livescoresfri.scoreboard.gameScore[0].homeScore, out y);
                        Response.Write("<span class='win'>" + livescoresfri.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        //}
                    ...
                    else
                    {
                        ...
                        Int32.TryParse(livescoresfri.scoreboard.gameScore[0].awayScore, out x);
                        Int32.TryParse(livescoresfri.scoreboard.gameScore[0].homeScore, out y);
                        Response.Write("<span class='win'>" + livescoresfri.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        //}
                    ...
                    string[] gamePicksList = { game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i], game14List[i]   };
                    string[] sundayPickGameIDs = {  "114034","114035","114036","114037","114038","114039","114040","114041","114042","114043","114044" };
