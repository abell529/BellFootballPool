<%@ Page Language="C#" AutoEventWireup="true" CodeFile="15-fifteenthwk.aspx.cs" Debug="true" Inherits="_2023_15_fifteenthwk" %>
...
<head runat="server">
    <title>
		Week 15 2023 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2023 Week 15: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "114075","114076","114077","114078","114084","114118","114120","114079","114080","114081","114083" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("</div>");
                    ...
                    if (game3List[i] == (livescoressat.scoreboard.gameScore[2].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[2].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    string[] sundayPickGameIDs = {  "114075","114076","114077","114078","114084","114118","114120","114079","114080","114081","114083" };
