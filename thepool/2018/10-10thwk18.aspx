<%@ Page Language="C#" AutoEventWireup="true" CodeFile="10-10thwk18.aspx.cs" Inherits="_2018_10_10thwk18" %>
...
<body>
    ...
    <h1>2018 Week 10: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "46079", "46080", "46081", "46082", "46083", "46084", "46085", "46086", "46087", "46088", "46089", "46090"/*, "46035"  , "xxxxxx" */ };
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = { "46079", "46080", "46081", "46082", "46083", "46084", "46085", "46086", "46087", "46088", "46089", "46090"/*, "46035"  , "xxxxxx" */ };

                    bool breakFlag = false;
                    

                    for (int a = 1; a <= 12 /* 14 */; a++)
                    {
                        int b = 0;
                    ...
                    if (game13List[i] /* game15List[i] */ == (livescores3.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
