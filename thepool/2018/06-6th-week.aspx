<%@ Page Language="C#" AutoEventWireup="true" CodeFile="06-6th-week.aspx.cs" Inherits="_2018_06_6th_week" %>
...
<head runat="server">
    <title>
		Week 6 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2018 Week 6: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% for (int i = 0; i < numberofgames; i++)
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = { "46023", "46024", "46025", "46026", "46027", "46028", "46029", "46030", "46031", "46032", "46033", "46034", "46035" /* , "xxxxxx" */ };

                    for (int a = 0; a < 13 /* 14 */; a++)
                    {
                        int b = 0;
                    ...
                    if (game14List[i] /* game15List[i] */ == (livescores3.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
