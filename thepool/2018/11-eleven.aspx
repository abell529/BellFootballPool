<%@ Page Language="C#" AutoEventWireup="true" CodeFile="11-eleven.aspx.cs" Inherits="_2018_11_eleven" %>
...
<head runat="server">
    <title>
		Week 11 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2018 Week 11: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "46093", "46094", "46095", "46096", "46097", "46098", "46099", "46100", "46101", "46102", "46103"/*, "46090", "46035" , "xxxxxx" */ };
                for (int i = 0; i < numberofgames; i++)
                {
                    ...
                    else
                    {
                        ...
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores3.scoreboard.gameScore[i - 12].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores3.scoreboard.gameScore[i - 12].homeScore + "</span></div>");
                        Response.Write("</div>");
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = { "46093", "46094", "46095", "46096", "46097", "46098", "46099", "46100", "46101", "46102", "46103"/*, "46090", "46035" , "xxxxxx" */ };

                    bool breakFlag = false;
                    

                    for (int a = 1; a <= 11 /* 14 */; a++)
                    {
                        int b = 0;
                                ...
                                while (d < livescores2.scoreboard.gameScore.Length)
                                {
                                    if (showall.fullgameschedule.gameentry[a].id == livescores2.scoreboard.gameScore[d].game.ID)
                                    {
                                        ...
                                        for (int c = 0; c < gamePicksList.Length; c++)
                                        {
                                            ...
                                            /* else
                                            {
                                                Response.Write("<span class='home'>ZZZ</span>");
                                                b++;
                    ...
                    if (game12List[i] /* game15List[i] */ == (livescores3.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores3.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
