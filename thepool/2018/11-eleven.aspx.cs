...
public partial class _2018_11_eleven : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM eleven2018 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13/*, string game14, string game15 , string game16 */)
    {
        ...
        // string[] sundayGameIDs = { "46093", "46094", "46095", "46096", "46097", "46098", "46099", "46100", "46101", "46102", "46103"/*, "46090", "46035" , "xxxxxx" */ };
        ...
        string[] mondaypicks = { game13 /* game16 */ };
