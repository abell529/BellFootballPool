...
public partial class _2018_08_8thwk : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OleDbCommand comPicks = new OleDbCommand("SELECT * FROM eight2018 ORDER BY uCase(lastname),uCase(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14/*, string game15 , string game16 */)
    {
        ...
        string[] sundayGameIDs = { "46052", "46053", "46054", "46055", "46056", "46057", "46058", "46059", "46060", "46061", "46062", "46063"/*, "46035" , "xxxxxx" */ };
        ...
        string[] mondaypicks = { game14 /* game16 */ };
