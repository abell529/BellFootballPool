...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OleDbCommand command = new OleDbCommand("SELECT * from 2017 ORDER BY total DESC, lastname ASC, firstname ASC", connection);
    ...
    protected void SendMail()
    {
        ...
        body += "\n Picks Link: http://www.bellfusion.com/football/thepool/2017/10-tenthwk.aspx \n";
        // body += "Subject: " + YourSubject.Text + "\n";
        // body += "Question: \n" + Comments.Text + "\n";
        // smtp settings
        var smtp = new System.Net.Mail.SmtpClient();
        {
            smtp.Host = "mail.bellfusion.com";
            smtp.Port = 587;
