...
public partial class add_picks : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MySqlCommand command = new MySqlCommand("SELECT * FROM `2023` ORDER BY total DESC, lastname ASC, firstname ASC", connection);
    ...
    protected void SubmitForm(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MySqlCommand cmd = new MySqlCommand(
                "INSERT INTO five2024 (firstname, lastname, email, game1, game2, game3, game4, game5, game6, game7, game8, game9, game10, game11, game12, game13, game14, game15, game16) " +
            ...
            SendMail();
            Response.Redirect("/football/thepool/2024/06-wk6.aspx");
        }
        catch (Exception ex)
        {
            successText = "Failed due to: " + ex.Message;
