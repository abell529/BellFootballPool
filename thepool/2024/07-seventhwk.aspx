<%@ Page Language="C#" AutoEventWireup="true" CodeFile="07-seventhwk.aspx.cs" Debug="true" Inherits="_2024_07_seventhwk" %>
...
<body>
    ...
    <h1>2024 Week 7: BellFootball Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134405","134406","134407","134408","134409","134410","134411","134412","134413","134414","134415","134416" };
                for (int i = 0; i < 15; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] gamePicksList = { game1List[i], game2List[i], game3List[i], game4List[i], game5List[i], game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i]  };
                    string[] sundayPickGameIDs = {  "134405","134406","134407","134408","134409","134410","134411","134412","134413","134414","134415","134416" };
