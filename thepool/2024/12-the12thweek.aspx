<%@ Page Language="C#" AutoEventWireup="true" CodeFile="12-the12thweek.aspx.cs" Debug="true" Inherits="_2024_12_the12thweek" %>
...
<head runat="server">
    <title>
		Week 12 2024 -- BellFootball Pool
	</title>
...
<body>
    ...
    <h1>2024 Week 12: BellFootball Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134479","134480","134481","134482","134483","134484","134485","134486","134487","134488","134489" };
                for (int i = 0; i < 13; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "134479","134480","134481","134482","134483","134484","134485","134486","134487","134488","134489" };
