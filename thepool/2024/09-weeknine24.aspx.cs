...
public partial class _2024_09_weeknine24 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // var responsescoresfri = client.DownloadString(urlscoreswk1fri);
        ...
        connPicks.Open();
        MySqlCommand comPicks = new MySqlCommand("SELECT * FROM `nine2024` ORDER BY UPPER(lastname), UPPER(firstname)", connPicks);
