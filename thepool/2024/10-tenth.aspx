<%@ Page Language="C#" AutoEventWireup="true" CodeFile="10-tenth.aspx.cs" Debug="true" Inherits="_2024_10_tenth" %>
...
<head runat="server">
    <title>
		Week 10 2024 -- BellFootball Pool
	</title>
...
<body>
    ...
    <h1>2024 Week 10: BellFootball Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134451","134452","134453","134454","134455","134456","134457","134458","134459","134460","134461","134462" };
                for (int i = 0; i < 14; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "134451","134452","134453","134454","134455","134456","134457","134458","134459","134460","134461","134462" };
