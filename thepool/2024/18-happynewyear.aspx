<%@ Page Language="C#" AutoEventWireup="true" CodeFile="18-happynewyear.aspx.cs" Debug="true" Inherits="_2024_18_happynewyear" %>
...
<head runat="server">
    <title>
		Week 18 2024 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2024 Week 18: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134570","134572","134575","134576","134579","134581","134583","134584","134569","134573","134577","134578","134580","134574" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("</div>");
                    ...
                    string[] sundayPickGameIDs = {  "134570","134572","134575","134576","134579","134581","134583","134584","134569","134573","134577","134578","134580","134574" };
