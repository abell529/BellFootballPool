...
public partial class _2024_01_firstwk24 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        connPicks.Open();
        MySqlCommand comPicks = new MySqlCommand("SELECT * FROM `one2024` ORDER BY UPPER(lastname), UPPER(firstname)", connPicks);
    ...
    public int ScoringGames(string scoringFirstName, string scoringLastName, string game1, string game2, string game3, string game4, string game5, string game6, string game7, string game8, string game9, string game10, string game11, string game12, string game13, string game14, string game15, string game16)
    {
        ...
        if (game2 == (livescoresfri.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoresfri.scoreboard.gameScore[0].game.awayTeam.Name))
        {
            int x;
            int y;
