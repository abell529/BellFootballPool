<%@ Page Language="C#" AutoEventWireup="true" CodeFile="17-10gamescount.aspx.cs" Debug="true" Inherits="_2024_17_10gamescount" %>
...
<head runat="server">
    <title>
		Week 17 2024 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2024 Week 17: BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134555","134556","134558","134559","134560","134567","134561","134557","134568" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                    ...
                    if (i == 0)
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescoresxmas.scoreboard.gameScore[i].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescoresxmas.scoreboard.gameScore[i].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i == 1)
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescoresxmas.scoreboard.gameScore[1].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescoresxmas.scoreboard.gameScore[1].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i == 2)
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescores.scoreboard.gameScore[0].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescores.scoreboard.gameScore[0].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i == 3)
                    {
                    ...
                    {
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].awayTeam.City + " <span class='heavy-font'>" + livescoressat.scoreboard.gameScore[2].awayScore + "</span></div>");
                        Response.Write("<div class='tk-ardoise-compact-std regular-font'>vs.</div>");
                        Response.Write("<div class='tk-ardoise-compact-std light-font smaller-font'>" + showall.fullgameschedule.gameentry[i].homeTeam.City + " <span class='heavy-font'>" + livescoressat.scoreboard.gameScore[2].homeScore + "</span></div>");
                        Response.Write("</div>");
                    }
                    else if (i > 5 && i < 15 )
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                   ...
                   Response.Write("</div>");
                    ...
                    if (game0List[i] == (livescoresxmas.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoresxmas.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        ...
                        Response.Write("<span class='win'>" + livescoresxmas.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                    ...
                    else
                    {
                        ...
                        Int32.TryParse(livescoresxmas.scoreboard.gameScore[0].awayScore, out x);
                        Int32.TryParse(livescoresxmas.scoreboard.gameScore[0].homeScore, out y);
                        Response.Write("<span class='win'>" + livescoresxmas.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                    ...
                    Response.Write("</div>");
                    Response.Write("<div class='divTableCell' style = 'background:#eae9e5;'>");

                    if (game1List[i] == (livescoresxmas.scoreboard.gameScore[1].game.awayTeam.City + " " + livescoresxmas.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    else
                    {
                        ...
                        Int32.TryParse(livescoresxmas.scoreboard.gameScore[1].awayScore, out x);
                        Int32.TryParse(livescoresxmas.scoreboard.gameScore[1].homeScore, out y);
                        Response.Write("<span class='win'>" + livescoresxmas.scoreboard.gameScore[1].game.homeTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        //}
                    ...
                    if (game2List[i] == (livescores.scoreboard.gameScore[0].game.awayTeam.City + " " + livescores.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    if (game3List[i] == (livescoressat.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    if (game4List[i] == (livescoressat.scoreboard.gameScore[1].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[1].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    if (game5List[i] == (livescoressat.scoreboard.gameScore[2].game.awayTeam.City + " " + livescoressat.scoreboard.gameScore[2].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                        ...
                        Response.Write("<span class='win'>" + livescoressat.scoreboard.gameScore[2].game.awayTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='win'>" + livescores.scoreboard.gameScore[0].game.awayTeam.Abbreviation + "</span>");
                        //}
                    ...
                    else
                    {
                        ...
                        Int32.TryParse(livescoressat.scoreboard.gameScore[2].awayScore, out x);
                        Int32.TryParse(livescoressat.scoreboard.gameScore[2].homeScore, out y);
                        Response.Write("<span class='win'>" + livescoressat.scoreboard.gameScore[2].game.homeTeam.Abbreviation + "</span>");
                        //if (x > y)
                        //{
                        //    Response.Write("<span class='loss'>" + livescores.scoreboard.gameScore[0].game.homeTeam.Abbreviation + "</span>");
                        //}
                    ...
                    string[] gamePicksList = { game6List[i], game7List[i], game8List[i], game9List[i], game10List[i], game11List[i], game12List[i], game13List[i], game14List[i]   };
                    string[] sundayPickGameIDs = {  "134555","134556","134558","134559","134560","134567","134561","134557","134568" };
