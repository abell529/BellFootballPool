<%@ Page Language="C#" AutoEventWireup="true" CodeFile="14-week14.aspx.cs" Debug="true" Inherits="_2024_14_week14" %>
...
<head runat="server">
    <title>
		Week 14 2024 -- BellFootball Pool
	</title>
...
<body>
    ...
    <h1>2024 Week 14: BellFootball Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134508","134509","134510","134511","134512","134513","134514","134515","134516","134517","134518" };
                for (int i = 0; i < 13; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "134508","134509","134510","134511","134512","134513","134514","134515","134516","134517","134518" };
