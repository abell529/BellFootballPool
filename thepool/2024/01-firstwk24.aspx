<%@ Page Language="C#" AutoEventWireup="true" CodeFile="01-firstwk24.aspx.cs" Debug="true" Inherits="_2024_01_firstwk24" %>
...
<body>
    ...
    <h1>2024 Week 1: BellFootball Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "134314","134315","134316","134317","134318","134319","134320","134321","134322","134323","134324","134325","134326" };
                for (int i = 0; i < 16; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    if (game1List[i] == (livescoresfri.scoreboard.gameScore[0].game.awayTeam.City + " " + livescoresfri.scoreboard.gameScore[0].game.awayTeam.Name))
                    {
                        int x;
                        int y;
                    ...
                    string[] sundayPickGameIDs = {  "134314","134315","134316","134317","134318","134319","134320","134321","134322","134323","134324","134325","134326" };
