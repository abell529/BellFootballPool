<%@ Page Language="C#" AutoEventWireup="true" CodeFile="10-10thweek.aspx.cs" Inherits="_2019_10_10thweek" %>
...
<head runat="server">
    <title>
		Week 10 -- BellFusion Football Pool
	</title>
...
<body>
    ...
    <h1>2019 Week 10 : BellFusion Football Pool Picks</h1>
<p>
...
<div class="divTableCell">&nbsp;</div>
            ...
            <% 
                string[] sundayPickGameIDsA = { "51597", "51598", "51599", "51600", "51601", "51602", "51603", "51604", "51605", "51606", "51607" };
                for (int i = 0; i < 13; i++)
                {
                    if (i % 2 == 0)
                    {
                ...
                for (int i = 0; i < theFirstNamePicks.Length; i++)
                {
                    ...
                    string[] sundayPickGameIDs = {  "51597", "51598", "51599", "51600", "51601", "51602", "51603", "51604", "51605", "51606", "51607" };
